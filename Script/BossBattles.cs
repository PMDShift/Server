        ...
        public static void RunBossBattleCleanup(Client client, string tag)
        {
            ...
            switch (map.MapBase)
            {
                ...
                case 1335:
                    {//attic
                        ...
                        if (map.Tile[9, 1].Type != Enums.TileType.Scripted)
                        {
                            ...
                            foreach (Client target in client.Player.Map.GetClients())
                            {
                                client.Player.Map.SpawnItem(452, 1, false, false, "", client.Player.Map.IsSandboxed, 8 + 2 * (players % 2), 5 + 2 * (players / 2), target);
                                players++;
                            }
                        }
                    }
                ...
                case 718:
                    {//basement
                        ...
                        if (map.Tile[9, 1].Type != Enums.TileType.Scripted)
                        {
                            ...
                            foreach (Client target in client.Player.Map.GetClients())
                            {
                                client.Player.Map.SpawnItem(452, 1, false, false, "", client.Player.Map.IsSandboxed, 8 + 2 * (players % 2), 6 + 2 * (players / 2), target);
                                players++;
                            }
                        }
                    }
                ...
                case 1704:
                    ...
                    break;
                case 1705:
                    {//Sacred Tower, Electrical Passage
