                    ...
                    case "mapdata":
                        {
                            ...
                            for (Y = 0; Y <= map.MaxY; Y++)
                            {
                                for (X = 0; X <= map.MaxX; X++)
                                {
                                    ...
                                    map.Tile[X, Y].Mask3 = parse[n + 6].ToInt();
                                    map.Tile[X, Y].M3Anim = parse[n + 7].ToInt();
                                    map.Tile[X, Y].Mask4 = parse[n + 8].ToInt();
                                    map.Tile[X, Y].M4Anim = parse[n + 9].ToInt();
                                    map.Tile[X, Y].Mask5 = parse[n + 10].ToInt();
                                    map.Tile[X, Y].M5Anim = parse[n + 11].ToInt();
                                    map.Tile[X, Y].Fringe = parse[n + 12].ToInt();
                                    map.Tile[X, Y].FAnim = parse[n + 13].ToInt();
                                    map.Tile[X, Y].Fringe2 = parse[n + 14].ToInt();
                                    map.Tile[X, Y].F2Anim = parse[n + 15].ToInt();
                                    map.Tile[X, Y].Fringe3 = parse[n + 16].ToInt();
                                    map.Tile[X, Y].F3Anim = parse[n + 17].ToInt();
                                    map.Tile[X, Y].Fringe4 = parse[n + 18].ToInt();
                                    map.Tile[X, Y].F4Anim = parse[n + 19].ToInt();
                                    map.Tile[X, Y].Fringe5 = parse[n + 20].ToInt();
                                    map.Tile[X, Y].F5Anim = parse[n + 21].ToInt();
                                    map.Tile[X, Y].Type = (Enums.TileType)parse[n + 22].ToInt();
                                    map.Tile[X, Y].Data1 = parse[n + 23].ToInt();
                                    map.Tile[X, Y].Data2 = parse[n + 24].ToInt();
                                    map.Tile[X, Y].Data3 = parse[n + 25].ToInt();
                                    map.Tile[X, Y].String1 = parse[n + 26];
                                    map.Tile[X, Y].String2 = parse[n + 27];
                                    map.Tile[X, Y].String3 = parse[n + 28];
                                    map.Tile[X, Y].RDungeonMapValue = parse[n + 29].ToInt();
                                    map.Tile[X, Y].GroundSet = parse[n + 30].ToInt();
                                    map.Tile[X, Y].GroundAnimSet = parse[n + 31].ToInt();
                                    map.Tile[X, Y].MaskSet = parse[n + 32].ToInt();
                                    map.Tile[X, Y].AnimSet = parse[n + 33].ToInt();
                                    map.Tile[X, Y].Mask2Set = parse[n + 34].ToInt();
                                    map.Tile[X, Y].M2AnimSet = parse[n + 35].ToInt();
                                    map.Tile[X, Y].Mask3Set = parse[n + 36].ToInt();
                                    map.Tile[X, Y].M3AnimSet = parse[n + 37].ToInt();
                                    map.Tile[X, Y].Mask4Set = parse[n + 38].ToInt();
                                    map.Tile[X, Y].M4AnimSet = parse[n + 39].ToInt();
                                    map.Tile[X, Y].Mask5Set = parse[n + 40].ToInt();
                                    map.Tile[X, Y].M5AnimSet = parse[n + 41].ToInt();
                                    map.Tile[X, Y].FringeSet = parse[n + 42].ToInt();
                                    map.Tile[X, Y].FAnimSet = parse[n + 43].ToInt();
                                    map.Tile[X, Y].Fringe2Set = parse[n + 44].ToInt();
                                    map.Tile[X, Y].F2AnimSet = parse[n + 45].ToInt();
                                    map.Tile[X, Y].Fringe3Set = parse[n + 46].ToInt();
                                    map.Tile[X, Y].F3AnimSet = parse[n + 47].ToInt();
                                    map.Tile[X, Y].Fringe4Set = parse[n + 48].ToInt();
                                    map.Tile[X, Y].F4AnimSet = parse[n + 49].ToInt();
                                    map.Tile[X, Y].Fringe5Set = parse[n + 50].ToInt();
                                    map.Tile[X, Y].F5AnimSet = parse[n + 51].ToInt();
                                    n += 52;
