        ...
        */
        ...
        public static void SendTemporaryTileTo(PacketHitList hitlist, Client client, int x, int y, Tile tile)
        {
            ...
            packet.AppendParameters(
                ...
                tile.Mask3.ToString(),
                tile.M3Anim.ToString(),
                tile.Mask4.ToString(),
                tile.M4Anim.ToString(),
                tile.Mask5.ToString(),
                tile.M5Anim.ToString(),
                tile.Fringe.ToString(),
                tile.FAnim.ToString(),
                tile.Fringe2.ToString(),
                tile.F2Anim.ToString(),
                tile.Fringe3.ToString(),
                tile.F3Anim.ToString(),
                tile.Fringe4.ToString(),
                tile.F4Anim.ToString(),
                tile.Fringe5.ToString(),
                tile.F5Anim.ToString(),
                ...
                tile.Mask3Set.ToString(),
                tile.M3AnimSet.ToString(),
                tile.Mask4Set.ToString(),
                tile.M4AnimSet.ToString(),
                tile.Mask5Set.ToString(),
                tile.M5AnimSet.ToString(),
                tile.FringeSet.ToString(),
                tile.FAnimSet.ToString(),
                tile.Fringe2Set.ToString(),
                tile.F2AnimSet.ToString(),
                tile.Fringe3Set.ToString(),
                tile.F3AnimSet.ToString(),
                tile.Fringe4Set.ToString(),
                tile.F4AnimSet.ToString(),
                tile.Fringe5Set.ToString(),
                tile.F5AnimSet.ToString()
            );
        ...
        public static void SendTile(int x, int y, IMap map)
        {
            ...
            packet.AppendParameters(
                ...
                map.Tile[x, y].Mask3.ToString(),
                map.Tile[x, y].M3Anim.ToString(),
                map.Tile[x, y].Mask4.ToString(),
                map.Tile[x, y].M4Anim.ToString(),
                map.Tile[x, y].Mask5.ToString(),
                map.Tile[x, y].M5Anim.ToString(),
                map.Tile[x, y].Fringe.ToString(),
                map.Tile[x, y].FAnim.ToString(),
                map.Tile[x, y].Fringe2.ToString(),
                map.Tile[x, y].F2Anim.ToString(),
                map.Tile[x, y].Fringe3.ToString(),
                map.Tile[x, y].F3Anim.ToString(),
                map.Tile[x, y].Fringe4.ToString(),
                map.Tile[x, y].F4Anim.ToString(),
                map.Tile[x, y].Fringe5.ToString(),
                map.Tile[x, y].F5Anim.ToString(),
                ...
                map.Tile[x, y].Mask3Set.ToString(),
                map.Tile[x, y].M3AnimSet.ToString(),
                map.Tile[x, y].Mask4Set.ToString(),
                map.Tile[x, y].M4AnimSet.ToString(),
                map.Tile[x, y].Mask5Set.ToString(),
                map.Tile[x, y].M5AnimSet.ToString(),
                ...
                map.Tile[x, y].Fringe3Set.ToString(),
                map.Tile[x, y].F3AnimSet.ToString(),
                map.Tile[x, y].Fringe4Set.ToString(),
                map.Tile[x, y].F4AnimSet.ToString(),
                map.Tile[x, y].Fringe5Set.ToString(),
                map.Tile[x, y].F5AnimSet.ToString()
            );
